/*
 * vdi_textblit.h - types shared by the VDI text blit code
 *
 * The LOCALVARS structure used to be private to vdi_textblit.c.  It is
 * published here so that framebuffer-format-specific drivers (see
 * vdi_raster_driver.h) can implement the text entries of VDI_RASTER_DRIVER.
 *
...
#ifndef _VDI_TEXTBLIT_H
#define _VDI_TEXTBLIT_H
