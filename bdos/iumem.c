 ...
 */
MEMORY_DESCRIPTOR *ffit(ULONG amount, MEMORY_PARTITION_BLOCK *mp) 
{
...
MEMORY_DESCRIPTOR *find_first_large_enough_free_block(ULONG amount, MEMORY_PARTITION_BLOCK *mp, UBYTE *start_address)
{
    MEMORY_DESCRIPTOR *middle_block; 
    LONG s;
#endif
